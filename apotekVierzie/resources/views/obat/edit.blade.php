        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Update Obat {{ $obat->obat->nama_obat }}</h4>
                    <p class="card-description">Edit Obat</p>

                    <form class="forms-sample" action="{{ route('obat.update', $obat->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            <label for="exampleInputNation">Tanggal Produksi</label>
